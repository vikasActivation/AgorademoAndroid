...
class VideoChatViewActivity : AppCompatActivity() {
    ...
    var appId = "261c4a2a89f24a84b90f96338dd3ae1f"
    var appCertificate = "d213f9dc09244de3bb58fc7c7c702c30"
    var channelName = "demo"

    var userAccount = "443307"
    var uid = 0
    ...
    fun onLocalVideoMuteClicked(view: View) {
        ...
        if (iv.isSelected) {
            ...
            iv.isSelected = true
            iv.setColorFilter(resources.getColor(R.color.purple_500), PorterDuff.Mode.MULTIPLY)
        }
